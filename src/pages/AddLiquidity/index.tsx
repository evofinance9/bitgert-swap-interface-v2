...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@evofinance9/sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@evofinance9/uikit'
...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    if (currencyA === ETHER || currencyB === ETHER) {
      ...
      estimate = router.estimateGas.addLiquidityBRISE
      method = router.addLiquidityBRISE
      args = [
